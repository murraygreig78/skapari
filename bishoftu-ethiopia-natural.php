<!DOCTYPE html>
<!-- saved from url=(0058)http://localhost/skapari/project/bishoftu-ethiopia-natural -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    
    <meta name="viewport" content="width=device-width, initial-scale=1.0, shrink-to-fit=no">
    <title>Skapari - BISHOFTU-ETHIOPIA: natural </title>
    ...
    <link rel="stylesheet" href="./BISHOFTU-ETHIOPIA_ natural_files/styles.css">
    <link href="./BISHOFTU-ETHIOPIA_ natural_files/css" rel="stylesheet">
    ...
    <section class="container">
        <div class="row">
            <div class="col-md-10 offset-md-1 heading">
                                <h3 class="skapari-heading  Hospitality">Hospitality<span>  BISHOFTU-ETHIOPIA:  natural</span>
                </h3>
            </div>
        </div>
        <div class="row">
